(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'kotlinx-coroutines-core', 'kotlin-wrappers-kotlin-react-jsLegacy', 'kotlin-wrappers-kotlin-react-dom-jsLegacy', 'kotlinx-html-js', 'kotlin-css', 'kotlin-wrappers-kotlin-styled-jsLegacy', 'react-share', 'react-player'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('kotlinx-coroutines-core'), require('kotlin-wrappers-kotlin-react-jsLegacy'), require('kotlin-wrappers-kotlin-react-dom-jsLegacy'), require('kotlinx-html-js'), require('kotlin-css'), require('kotlin-wrappers-kotlin-styled-jsLegacy'), require('react-share'), require('react-player'));
  else {
    if (typeof kotlin === 'undefined') {
      ...
      throw new Error("Error loading module 'KotlinBrowser'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'KotlinBrowser'.");
      ...
      throw new Error("Error loading module 'KotlinBrowser'. Its dependency 'kotlinx-html-js' was not found. Please, check whether 'kotlinx-html-js' is loaded prior to 'KotlinBrowser'.");
      ...
      throw new Error("Error loading module 'KotlinBrowser'. Its dependency 'react-share' was not found. Please, check whether 'react-share' is loaded prior to 'KotlinBrowser'.");
    }if (typeof this['react-player'] === 'undefined') {
      throw new Error("Error loading module 'KotlinBrowser'. Its dependency 'react-player' was not found. Please, check whether 'react-player' is loaded prior to 'KotlinBrowser'.");
    }root.KotlinBrowser = factory(typeof KotlinBrowser === 'undefined' ? {} : KotlinBrowser, kotlin, this['kotlinx-coroutines-core'], this['kotlin-wrappers-kotlin-react-jsLegacy'], this['kotlin-wrappers-kotlin-react-dom-jsLegacy'], this['kotlinx-html-js'], this['kotlin-css'], this['kotlin-wrappers-kotlin-styled-jsLegacy'], this['react-share'], this['react-player']);
  }
}(this, function (_, Kotlin, $module$kotlinx_coroutines_core, $module$kotlin_wrappers_kotlin_react_jsLegacy, $module$kotlin_wrappers_kotlin_react_dom_jsLegacy, $module$kotlinx_html_js, $module$kotlin_css, $module$kotlin_wrappers_kotlin_styled_jsLegacy, $module$react_share, $module$react_player) {
  'use strict';
  ...
  App.prototype.render_ss14n$ = function ($receiver) {
    ...
    $receiver_0.unaryPlus_pdl1vz$('Kotlin First Sample WebApp');
