(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    }root.KotlinBrowser = factory(typeof KotlinBrowser === 'undefined' ? {} : KotlinBrowser, kotlin, this['kotlin-wrappers-kotlin-react-dom-jsLegacy'], this['kotlin-css'], this['kotlin-wrappers-kotlin-styled-jsLegacy'], this['kotlin-wrappers-kotlin-react-jsLegacy'], this['kotlinx-html-js']);
  }
  ...
  App.prototype.render_ss14n$ = function ($receiver) {
    ...
    set_right($receiver_1, get_px(30));
  ...
  function VideoList$render$lambda$lambda$lambda$lambda(closure$video) {
    return function ($receiver) {
      $receiver.selectedVideo = closure$video;
      return Unit;
    };
  }
  function VideoList$render$lambda$lambda$lambda(closure$video, this$VideoList) {
    return function (it) {
      setState(this$VideoList, VideoList$render$lambda$lambda$lambda$lambda(closure$video));
      return Unit;
    };
  }
  VideoList.prototype.render_ss14n$ = function ($receiver) {
    ...
    while (tmp$.hasNext()) {
      ...
      set_onClickFunction($receiver_0.attrs, VideoList$render$lambda$lambda$lambda(video, this));
      if (equals(video, this.state.selectedVideo)) {
  ...
  _.main = main;
  unwatchedVideos = listOf([new Video(1, 'Building and breaking things', 'John Doe', 'https://youtu.be/PsaFVLr8t4E'), new Video(2, 'The development process', 'Jane Smith', 'https://youtu.be/PsaFVLr8t4E'), new Video(3, 'The Web 7.0', 'Matt Miller', 'https://youtu.be/PsaFVLr8t4E'), new Video(4, 'The Web 7.0', 'Matt Miller', 'https://youtu.be/PsaFVLr8t4E'), new Video(5, 'The Web 7.0', 'Matt Miller', 'https://youtu.be/PsaFVLr8t4E'), new Video(6, 'The Web 7.0', 'Matt Miller', 'https://youtu.be/PsaFVLr8t4E')]);
  watchedVideos = listOf([new Video(8, 'Mouseless development', 'Tom Jerry', 'https://youtu.be/PsaFVLr8t4E'), new Video(7, 'The Web 7.0', 'Matt Miller', 'https://youtu.be/PsaFVLr8t4E')]);
  main();
